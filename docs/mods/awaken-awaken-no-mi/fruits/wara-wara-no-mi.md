...
Guarding enemies keep their doll and the user still can't carry more than ten
...
The doll is used up and goes back to its owner
...
The user still takes their own damage normally
