...
When the run ends, or on a second use, a stampede of phantom hooves thunders down the whole trail, trampling and throwing everything near it.

| Stat | Value |
|---|---|
| Damage | 70 |
| Reach From the Trail (blocks) | 4 |
| Run Recorded (s) | 5 |
| Movement Speed (%) | +80 |
| Cooldown | 35 s |
