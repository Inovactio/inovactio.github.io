...
|---|---|---|---|
| ![](../icons/mix_candy.png){ .item-icon }Mix Candy | 1 | 12 | 2 × ![](../icons/mystery_mushroom.png){ .item-icon }Mystery Mushroom, ![](../icons/sweet_sap.png){ .item-icon }Sweet Sap |
| ![](../icons/healing_candy.png){ .item-icon }Healing Candy | 2 | 14 | 4 × ![](../icons/medicinal_herb.png){ .item-icon }Medicinal Herb, ![](../icons/sweet_sap.png){ .item-icon }Sweet Sap |
| ![](../icons/dual_action_tonic.png){ .item-icon }Dual Action Tonic | 4 | 18 | 2 × ![](../icons/mystery_mushroom.png){ .item-icon }Mystery Mushroom, ![](../icons/bitter_grass.png){ .item-icon }Bitter Grass, ![](../icons/coconut.png){ .item-icon }Coconut |
| ![](../icons/healing_tonic.png){ .item-icon }Healing Tonic | 5 | 20 | 4 × ![](../icons/medicinal_herb.png){ .item-icon }Medicinal Herb, ![](../icons/coconut.png){ .item-icon }Coconut |
| ![](../icons/stamina_candy.png){ .item-icon }Stamina Candy | 7 | 24 | 2 × ![](../icons/wilted_carrot.png){ .item-icon }Wilted Carrot, ![](../icons/sweet_sap.png){ .item-icon }Sweet Sap |
| ![](../icons/stamina_tonic.png){ .item-icon }Stamina Tonic | 10 | 30 | 2 × ![](../icons/wilted_carrot.png){ .item-icon }Wilted Carrot, ![](../icons/coconut.png){ .item-icon }Coconut |
| ![](../icons/thunder_powder.png){ .item-icon }Thunder Powder ×2 | 12 | 34 | ![](../icons/lightning_beetle.png){ .item-icon }Lightning Beetle |
| ![](../icons/antidote_powder.png){ .item-icon }Antidote Powder | 14 | 38 | ![](../icons/doctor_hornet.png){ .item-icon }Doctor Hornet, 3 × ![](../icons/bitter_grass.png){ .item-icon }Bitter Grass |
| ![](../icons/salt_ball.png){ .item-icon }Salt Ball ×2 | 14 | 38 | ![](../icons/crystallised_salt.png){ .item-icon }Crystallised Salt, Cobweb |
| ![](../icons/flame_powder.png){ .item-icon }Flame Powder ×2 | 18 | 46 | ![](../icons/fire_hercules.png){ .item-icon }Fire Hercules |
| ![](../icons/ice_powder.png){ .item-icon }Ice Powder ×2 | 20 | 50 | ![](../icons/ice_sunfish.png){ .item-icon }Ice Sunfish |
| ![](../icons/poison_ball.png){ .item-icon }Poison Ball ×2 | 24 | 58 | ![](../icons/clawed_scorpion.png){ .item-icon }Clawed Scorpion, Clay Ball |
| Gunpowder ×2 | 26 | 62 | 3 × ![](../icons/explosive_rock_fragment.png){ .item-icon }Explosive Rock Fragment, any logs |
| ![](../icons/sleep_ball.png){ .item-icon }Sleep Ball ×2 | 28 | 66 | 2 × ![](../icons/sleep_honey.png){ .item-icon }Sleep Honey, 2 × Clay Ball |
| ![](../icons/potion_of_forgetting.png){ .item-icon }Potion of Forgetting | 30 | 70 | ![](../icons/golden_matsutake.png){ .item-icon }Golden Matsutake, ![](../icons/mystery_mushroom.png){ .item-icon }Mystery Mushroom, ![](../icons/bitter_grass.png){ .item-icon }Bitter Grass, ![](../icons/medicinal_herb.png){ .item-icon }Medicinal Herb, Glass Bottle |
| ![](../icons/restorative_drug.png){ .item-icon }Restorative Drug | 30 | 70 | ![](../icons/salamandrake.png){ .item-icon }Salamandrake, 3 × ![](../icons/lotus_seed.png){ .item-icon }Lotus Seed, ![](../icons/giant_devil_hand_moth.png){ .item-icon }Giant Devil Hand Moth |
| ![](../icons/instant_freeze_ball.png){ .item-icon }Instant Freeze Ball ×2 | 32 | 74 | 6 × ![](../icons/ice_powder.png){ .item-icon }Ice Powder, ![](../icons/crystallised_salt.png){ .item-icon }Crystallised Salt, 2 × Clay Ball |
| ![](../icons/revival_elixir.png){ .item-icon }Revival Elixir | 36 | 82 | ![](../icons/hydramandrake.png){ .item-icon }Hydramandrake, ![](../icons/rainbow_phoenix.png){ .item-icon }Rainbow Phoenix, ![](../icons/crossbone_butterfly.png){ .item-icon }Crossbone Butterfly, ![](../icons/spirit_firefly.png){ .item-icon }Spirit Firefly |
| ![](../icons/rumble_ball.png){ .item-icon }Rumble Ball | 42 | 94 | ![](../icons/golden_egg.png){ .item-icon }Golden Egg, ![](../icons/golden_fruit.png){ .item-icon }Golden Fruit, ![](../icons/golden_hercules.png){ .item-icon }Golden Hercules |
| ![](../icons/medicine.png){ .item-icon }Medicine | 46 | 102 | 2 × ![](../icons/thunder_powder.png){ .item-icon }Thunder Powder, 2 × ![](../icons/flame_powder.png){ .item-icon }Flame Powder, 2 × Gunpowder, 2 × ![](../icons/ice_powder.png){ .item-icon }Ice Powder |
| ![](../icons/experiment_equipment.png){ .item-icon }Experiment Equipment | 50 | 110 | 2 × ![](../icons/thunder_powder.png){ .item-icon }Thunder Powder, 2 × ![](../icons/flame_powder.png){ .item-icon }Flame Powder, 2 × Gunpowder, 2 × ![](../icons/ice_powder.png){ .item-icon }Ice Powder, ![](../icons/instant_freeze_ball.png){ .item-icon }Instant Freeze Ball |
