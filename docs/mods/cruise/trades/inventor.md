...
|---|---|---|---|---|---|
| ![](../icons/bamboo_flute.png){ .item-icon }Bamboo Flute | 6 | 3 Bamboo, String | 8 blocks | 20 minutes | 32 |
...
|---|---|---|---|
| ![](../icons/reel.png){ .item-icon }Reel | 1 | 12 | Iron Ingot, Stick, 2 × String |
| ![](../icons/sieve.png){ .item-icon }Sieve | 1 | 12 | any planks, Stick, 2 × String |
| ![](../icons/traps.png){ .item-icon }Traps | 1 | 12 | 3 × ![](../icons/nectar.png){ .item-icon }Nectar, Bamboo, any logs |
| ![](../icons/whopper_fishing_rod.png){ .item-icon }Whopper Fishing Rod | 5 | 20 | ![](../icons/reel.png){ .item-icon }Reel, Raw Iron |
| ![](../icons/bamboo_flute.png){ .item-icon }Bamboo Flute | 6 | 22 | 3 × Bamboo, String |
| ![](../icons/fishing_line_upgrade.png){ .item-icon }Fishing Line Upgrade | 8 | 26 | 9 × String |
| ![](../icons/fishing_rod_upgrade.png){ .item-icon }Fishing Rod Upgrade | 8 | 26 | Bamboo |
| ![](../icons/fine_sieve.png){ .item-icon }Fine Sieve | 12 | 34 | ![](../icons/sieve.png){ .item-icon }Sieve, 2 × ![](../icons/iron_scrap.png){ .item-icon }Iron Scrap, 2 × String |
| ![](../icons/iron_plating.png){ .item-icon }Iron Plating | 16 | 42 | 4 × Iron Ingot, 4 × ![](../icons/iron_scrap.png){ .item-icon }Iron Scrap, any planks |
| ![](../icons/whopper_rod_upgrade.png){ .item-icon }Whopper Rod Upgrade | 18 | 46 | Raw Iron, 2 × ![](../icons/iron_scrap.png){ .item-icon }Iron Scrap |
| ![](../icons/woodsmans_axe.png){ .item-icon }Woodsman's Axe | 20 | 50 | 2 × ![](../icons/pure_iron_ore.png){ .item-icon }Pure Iron Ore, 3 × ![](../icons/diamond_fragment.png){ .item-icon }Diamond Fragment, 2 × ![](../icons/mysterious_parts.png){ .item-icon }Mysterious Parts, 2 × any logs |
| ![](../icons/enhanced_traps.png){ .item-icon }Enhanced Traps | 22 | 54 | ![](../icons/sweet_sap.png){ .item-icon }Sweet Sap, 2 × ![](../icons/nectar.png){ .item-icon }Nectar, 3 × ![](../icons/iron_scrap.png){ .item-icon }Iron Scrap |
| ![](../icons/violin.png){ .item-icon }Violin | 22 | 54 | 3 × any planks, Stick, 4 × String, ![](../icons/sweet_sap.png){ .item-icon }Sweet Sap |
...
| ![](../icons/magnet.png){ .item-icon }Magnet | 30 | 70 | 3 × ![](../icons/pure_iron_ore.png){ .item-icon }Pure Iron Ore, Redstone Dust |
| ![](../icons/ultimate_reel.png){ .item-icon }Ultimate Reel | 30 | 70 | ![](../icons/reel.png){ .item-icon }Reel, 2 × ![](../icons/mysterious_parts.png){ .item-icon }Mysterious Parts, Raw Iron |
| ![](../icons/reinforced_frame.png){ .item-icon }Reinforced Frame | 31 | 72 | ![](../icons/hercules_beetle.png){ .item-icon }Hercules Beetle, ![](../icons/atlas_beetle.png){ .item-icon }Atlas Beetle, 3 × Iron Ingot, ![](../icons/mysterious_parts.png){ .item-icon }Mysterious Parts |
| ![](../icons/sea_king_fishing_rod.png){ .item-icon }Sea King Fishing Rod | 32 | 74 | ![](../icons/ultimate_reel.png){ .item-icon }Ultimate Reel, Cola |
| ![](../icons/mysterious_dial.png){ .item-icon }Mysterious Dial | 34 | 78 | 9 × ![](../icons/dial_fragment.png){ .item-icon }Dial Fragment |
| ![](../icons/felling_saw.png){ .item-icon }Felling Saw | 35 | 80 | 4 × ![](../icons/pure_iron_ore.png){ .item-icon }Pure Iron Ore, 3 × ![](../icons/mysterious_parts.png){ .item-icon }Mysterious Parts, 2 × any logs |
| ![](../icons/jet_dial.png){ .item-icon }Jet Dial ×3 | 36 | 82 | 7 × ![](../icons/dial_fragment.png){ .item-icon }Dial Fragment, 2 × ![](../icons/balloon_catfish.png){ .item-icon }Balloon Catfish |
