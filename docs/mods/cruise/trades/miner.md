...
From **Miner 10**, breaking one of Mine Mine no Mi's dials (Axe, Breath, Eisen, Flame, Flash, Impact, Milky or Reject Dial) with a pickaxe shatters it into 2 to 4 ![](../icons/dial_fragment.png){ .item-icon }**Dial Fragments**, **instead of** the dial itself. Below level 10, the dial breaks and drops as normal.
