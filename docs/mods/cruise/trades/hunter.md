...
|---|---|---|---|
| ![](../icons/traps.png){ .item-icon }**Traps** | 1 | 3 Nectar, 1 Bamboo, 1 log | 2 to 5 minutes |
| ![](../icons/enhanced_traps.png){ .item-icon }**Enhanced Traps** | 22 | 1 Sweet Sap, 2 Nectar, 3 Iron Scrap | 1 to 2.5 minutes |
...
|---|---|---|---|
| ![](../icons/extension_pole.png){ .item-icon }**Extension Pole** | 24 | reaches 2.5 blocks further | springs 35 % sooner |
| ![](../icons/reinforced_frame.png){ .item-icon }**Reinforced Frame** | 31 | wears half as often | survives its catch half the time |
| ![](../icons/steady_grip.png){ .item-icon }**Steady Grip** | 39 | holds a creature up to 5 Hunter levels above you | same |
| ![](../icons/catch_bag.png){ .item-icon }**Catch Bag** | 46 | 1 catch in 4 gives its by-products twice (never the creature itself) | same |
...
| ![](../icons/firefly_lantern.png){ .item-icon }Firefly Lantern | 12 | 34 | 3 × any fireflies, Glass, Iron Nugget |
| Slimeball ×2 | 16 | 42 | 2 × any frogs |
| ![](../icons/bait.png){ .item-icon }Bait ×4 | 22 | 54 | 2 × any wings, any hides, ![](../icons/nectar.png){ .item-icon }Nectar |
| ![](../icons/scent_lure.png){ .item-icon }Scent Lure ×2 | 38 | 86 | 2 × any hides, 2 × ![](../icons/nectar.png){ .item-icon }Nectar, any wings, Glass Bottle |
| ![](../icons/specimen_case.png){ .item-icon }Specimen Case | 46 | 102 | 5 × Glass, 2 × any planks, Iron Nugget, ![](../icons/marble.png){ .item-icon }Marble |

What the Tannery's own items do:

- ![](../icons/firefly_lantern.png){ .item-icon }**Firefly Lantern**: a jar of fireflies that gives light level 14.
- ![](../icons/bait.png){ .item-icon }**Bait**: *used* (right-click), not eaten. For 2 minutes you are Baited, and Cruise's fish bite 35 % more often (see the [Fisher](fisher.md)).
- ![](../icons/scent_lure.png){ .item-icon }**Scent Lure**: right-click to uncork it. It runs a minute's worth of creature spawning at once, but only brings creatures that would have come to that place anyway (same biome, time of day, height and nearby limits). In the wrong place it says "Nothing here answers it"; when it works, "Something moves nearby." You must wait 10 seconds before opening another.
- ![](../icons/specimen_case.png){ .item-icon }**Specimen Case**: a glass trophy case. Right-click it with any caught creature and the creature stands inside, turning slowly. An empty hand takes it back out, and breaking the case drops it. The creature is kept, never used up.
