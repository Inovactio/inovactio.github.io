...
| | |
|---|---|
| Who can read a map | only a Merchant: level 1, 20 or 75 by grade |
| Where | the Overworld |
| Grades | Rumor, Old (uncommon), Legendary (rare) |

## The torn maps

There are three grades: the **Torn Rumor Map**, the **Torn Old Map** and the **Torn Legendary Map**. The tooltip says who can read it ("Only a Merchant of level X can read it").
...
|---|---|---|---|
| Rumor | 1 | 150-400 blocks | 100 |
| Old | 20 | 400-900 blocks | 400 |
| Legendary | 75 | 900-1 800 blocks | 1 200 |
...
- "Very close!" within 4;
- "Right under your feet!" within 1.5.

The X alone only gets you within about 4 blocks, since one pixel of the map is 4 blocks: follow the hints for the rest.

!!! note "A copied map finds nothing"
    Each map has its own treasure. If you copy it at a cartography table, only the first copy to reach the X buries the chest; the others arrive at an empty spot.

## The chest

Anyone can open the chest, or break it. The first player to open it gets the "Treasure found" message and the **X Marks the Spot** advancement (and **Legendary Treasure** for a legendary map), plus the grade's Merchant XP if they practise the Merchant trade.

| | Rumor | Old | Legendary |
|---|---|---|---|
| Belly Pouch | 200-600 Belly | 1 000-3 000 Belly | 4 000-10 000 Belly |
...
|---|---|---|
| Gold Nugget ×3-8 (30) | Gold Ingot ×1-3 (25) | Gold Ingot ×2-5 (20) |
| Iron Ingot ×1-3 (20) | Diamond Fragment ×1-3 (20) | Diamond ×1-3 (15) |
| Iron Scrap ×1-3 (20) | Mysterious Parts (12) | Diamond Fragment ×2-4 (15) |
| Bottle of Rum ×1-2 (15) | Dial Fragment (10) | Sea King Scale ×1-2 (10) |
| Emerald (5) | Bottle of Rum ×1-3 (10) | Dial Fragment ×1-2 (10) |
| Golden Egg (5) | Emerald ×1-2 (10) | Golden Egg (10) |
| an ancient manual (3) | Diamond (8) | Emerald ×2-4 (10) |
| | Golden Egg (8) | Bubbly Coral (8) |
| | Bubbly Coral (6) | an ancient manual (6) |
| | an ancient manual (4) | Dense Kairoseki (5) |

The ancient manual is one of Mine Mine no Mi's books.
