...
Cruise Cruise no Mi adds **fourteen trades**. Each has its own level, its own page in the professions book, its own perks and its own advancements.
...
- The [Merchant](trades/merchant.md) makes nothing and gathers nothing: he learns by selling.

Two gatherers have a bench of their own too: the Hunter's **Tannery** and the Miner's **Masonry**; the Navigator works at the **Chart Table**.

## Levels and XP

Every trade starts at **level 1** and goes up to **level 100**. Most of this first version sits between levels 1 and 50; a few things already go further (the Musician's tier III scores, a legendary treasure map at Merchant 75).

Every trade uses the same curve: going from one level to the next costs **20 × (current level)<sup>1.25</sup> XP**, so each level costs a little more than the one before.
...
| Trade | XP for |
|---|---|
| **Makers** (every workstation) | every recipe: **10 + 2 × its level** (12 XP for a level-1 recipe, 70 at level 30, 110 at level 50) |
| **Fisher** | every Cruise catch (more for a bigger one), a bonus for the first of each kind, a slain Sea King |
...
| **Miner** | breaking ores with the right pickaxe, and every find that turns up in the rock; the Masonry's recipes |
| **Lumberjack** | every log felled from a standing, naturally grown tree (1 for ordinary wood, 2 for a fruit tree, 3 Kuuigosu, 4 Burning Tree, 6 Adam), 1 for planting a sapling; logs someone placed pay nothing |
| **Merchant** | 1 XP for every 10 Belly sold to Cruise's merchants or at the Auction House; a dug-up treasure (100, 400 or 1 200 by the map's grade) |
...
The [Bestiary and the log book](bestiary-and-logbook.md) also pay, every time you complete a further tenth of one of their sections: Belly to anyone, and XP in the trade if you practise it (50, 100, 150, 250, 400, 600, 900, 1 400, 2 200, then 6 000 XP).

### XP boosts

- Most Cruise **dishes** give an *Appetite* for 10 minutes: +15 %, +30 % or +45 % XP in one trade, the harder the dish the more. One Appetite at a time. See the [Cook](trades/cook.md).
...
| Hunter | They only catch creatures of Hunter level 1; anything harder "slips away". The Bestiary still fills. |
| Farmer | They cannot sow Cruise's crops or plant fruit-tree saplings; fruit they pick or crops they harvest are partly spoiled. |
| Lumberjack | They cannot plant the Kuuigosu, Burning Tree or Adam saplings, nor break the Treasure Tree Adam. |
...
| The makers | Each workstation belongs to its trade, and its recipes open by level. |
...
- **The cost**: on confirmation, **all your trade XP is wiped** (every trade, not only yours) and you take up the new trade from the start. Close the book instead and you keep the potion.
- In a **Solo** world there is nothing to forget: its recipe is removed, and a potion that still gets in refuses to be drunk.
...
- Each trade's tab opens at **level 1** in that trade, and holds one level milestone: **Apprentice**, level 5. Everything else is about doing things: a recipe made, a species caught, a dish eaten, a tree felled.
- The main tab's **Jack of All Trades** asks for level 5 in all fourteen trades: a Solo feat.
- Notable challenges: Naturalist (catch every creature), Gourmet (taste every dish), King of the Sea (kill a Sea King), All That Is Gold (land the Golden Whale), The Tree That Cannot Be Chopped Down (fell the Adam), SUPER! (a boat of Adam wood), Yohohoho! (forge the Soul Solid), Rumble! (a Rumble Ball), Legendary Treasure, Full House (play for three crewmates or more).
