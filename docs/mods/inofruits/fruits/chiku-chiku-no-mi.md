...
![](../abilities/chikuseki.png){ .ability-icon } *Passive*

Absorbs 30% of every hit the user takes and stores the full force of it

## Chikudan { #chikudan }

![](../abilities/chikudan.png){ .ability-icon } *Active*
...
![](../abilities/chikuken.png){ .ability-icon } *Active · Punch*
...
![](../abilities/kaiho.png){ .ability-icon } *Active*
