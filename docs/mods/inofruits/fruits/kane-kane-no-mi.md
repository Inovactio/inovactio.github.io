...
![](../fruit-icons/kane-kane-no-mi.png){ .mod-icon }
...
![](../abilities/komyaku.png){ .ability-icon } *Active*
...
![](../abilities/meate.png){ .ability-icon } *Active*
...
![](../abilities/nakami.png){ .ability-icon } *Active*
...
![](../abilities/kiun.png){ .ability-icon } *Passive*
