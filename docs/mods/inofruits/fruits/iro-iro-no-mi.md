...
![](../fruit-icons/iro-iro-no-mi.png){ .mod-icon }
...
| **Effects applied** | ![](../effect-icons/marked.png){ .effect-mini }[Marked](../effects.md#effect-marked), ![](../effect-icons/war-paint.png){ .effect-mini }[War Paint](../effects.md#effect-war-paint) |
...
![](../abilities/enogu-dama.png){ .ability-icon } *Active*
...
![](../abilities/hogoshoku.png){ .ability-icon } *Active*
...
![](../abilities/enogu.png){ .ability-icon } *Active*
