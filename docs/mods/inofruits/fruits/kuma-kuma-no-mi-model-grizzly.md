...
![](../fruit-icons/kuma-kuma-no-mi-model-grizzly.png){ .mod-icon }
...
![](../abilities/claw-swipe.png){ .ability-icon } *Active*
...
![](../abilities/salmon-swipe.png){ .ability-icon } *Active*
...
![](../abilities/maul.png){ .ability-icon } *Active*
...
![](../abilities/roar.png){ .ability-icon } *Active*
