...
<div class="model-viewer" data-models="../../" data-ids="forms/wani-wani-walk-point forms/wani-wani-heavy-point"></div>
...
![](../abilities/death-roll.png){ .ability-icon } *Active*
...
![](../abilities/tail-sweep.png){ .ability-icon } *Active*
