...
**Zoan** · ![Iron box](../../../assets/mineminenomi/iron_box.png "Iron box: texture from Mine Mine no Mi"){ .box-icon } Iron box · 8 abilities
...
![](../abilities/mushi-mushi-flight.png){ .ability-icon } *Passive*

Requires Mushi Mushi Fly Point or Mushi Mushi Heavy Point to be active.

## Mushi { #mushi }

![](../abilities/mushi.png){ .ability-icon } *Passive*

While in the mosquito form, hostile mobs won't target the user.

## Kyuketsu { #kyuketsu }

![](../abilities/kyuketsu.png){ .ability-icon } *Active*
...
![](../abilities/chibukuro.png){ .ability-icon } *Passive*
...
![](../abilities/kabashira.png){ .ability-icon } *Active*
